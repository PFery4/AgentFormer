...
if __name__ == '__main__':
    ...
    gt_Sig = torch.tensor([[dist_params["sig"][0]**2, dist_params["rho"] * dist_params["sig"][0] * dist_params["sig"][1]],
                        [dist_params["rho"] * dist_params["sig"][0] * dist_params["sig"][1], dist_params["sig"][1]**2]], dtype=torch.float64)
    ...
    for i in tqdm(range(n_training_steps)):
        ...
        mu, sig, rho = gauss(x)
        loss = gaussian_twodee_nll(mu, sig, rho, y)
